...
export const IncidentMultiMediaFiles: React.FC = () => {
  ...
  return (
    <MainContent aria-label="Main content">
      ...
      <ButtonRow>
        <ActionButton onClick={() => navigate('/control/emergency-incident-logging/record-modification-history')}>Save & Continue to Record Modification History</ActionButton>
      </ButtonRow>
    </MainContent>
  );
};
