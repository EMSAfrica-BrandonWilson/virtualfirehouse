  ...
  if (currentPath.startsWith('/control')) {
    ...
    if (currentPath.startsWith('/control/emergency-incident-logging')) {
      return [
        ...
        { name: 'property-information', path: '/control/emergency-incident-logging/property-information', text: 'Property Information' },
        { name: 'damage-loss-reporting', path: '/control/emergency-incident-logging/damage-loss', text: 'Damage / Loss Reporting' },
        { name: 'equipment-used', path: '/control/emergency-incident-logging/equipment-used', text: 'Equipment Used' },
