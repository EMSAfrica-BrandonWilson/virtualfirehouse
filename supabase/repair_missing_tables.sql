-- Repair script to create missing Damage/Loss tables
-- Run this in the Supabase SQL Editor

-- 1. Create Parent Table: 03_ecc_03_06_Damage_Loss_Reporting
...
-- 2. Create Items Table: 03_ecc_03_06_Damage_Loss_Reporting_Items
