-- Migration: Create Fire Station Menu and Equipment Management System (Fixed Data Types)
-- Created: 2025-10-29
-- Description: Implements the complete database schema for fire station menu items and equipment management
-- Fixed to use correct data types: integer for fire_station_id and department_id
